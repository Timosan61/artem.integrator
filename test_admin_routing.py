...
def test_admin_routing():
    ...
    try:
        ...
        try:
            ...
            print(f"   Обычное сообщение: {'❌ ОБРАБАТЫВАЕТ (неправильно)' if can_handle_regular else '✅ НЕ ОБРАБАТЫВАЕТ (правильно)'}")
        ...
        print("   • IntelligentAgent: обрабатывает MCP команды от админов")
        print("   • DefaultAgent: обрабатывает обычные сообщения от всех пользователей")
