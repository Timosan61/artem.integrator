        ...
        try:
            ...
            if self.openai_client is None:
                ...
                if any(word in user_message_lower for word in ['привет', 'hello', 'hi', 'здравствуй']):
                    ...
                    bot_response = f"Понял ваш вопрос: '{user_message}'. Это отличный вопрос о текстильном производстве! Для детальной консультации свяжитесь с нашими специалистами."
            else:
