"""
Конфигурация для Voice Service
"""
...
TEMP_AUDIO_DIR = os.path.join(tempfile.gettempdir(), "artem_voice")
...
WHISPER_LANGUAGE = None  # Автоопределение языка (можно задать "ru" для русского)
