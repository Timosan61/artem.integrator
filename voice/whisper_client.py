...
class WhisperTranscriber:
    ...
    async def transcribe(self, audio_file_path: str, language: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """
        Транскрибирует аудио файл в текст
        
        Args:
            audio_file_path: Путь к аудио файлу
            language: Язык аудио (опционально, по умолчанию автоопределение)
        
        Returns:
            Dict с результатом транскрипции или None при ошибке
        """
        try:
            # Валидация файла
